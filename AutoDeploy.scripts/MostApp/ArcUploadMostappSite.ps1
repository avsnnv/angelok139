...
Remove-Item -force c:\AutoDeploy\ftp_root\Most.Core.Last.$Release
cmd.exe /c mklink c:\AutoDeploy\ftp_root\Most.Core.Last.$Release c:\AutoDeploy\ftp_root\$Filename
